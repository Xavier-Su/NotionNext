...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        ...
        process.env.NOTION_PAGE_ID || 'ead8c890a4f249d98e363c52bb5693bc',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个程序员,欢迎来到我的知识库🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'XavierSu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个追求精神与技术的魔怔人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://www.learnya.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Xavier的Notion, 博客, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'xfeng.su@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Xavier-Su/', // 你的github个人主页 例如 https://github.com/tangly1024
